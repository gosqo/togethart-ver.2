...
public class MyPageService {
    ...
    public List<MyPageArtworksResponse> getMyPageArtworksWhole(Long memberId) {
        return myPageMapper.selectMyPageArtworksWhole(memberId);
    }

    public List<MyPageLikesResponse> getMyPageLikesWhole(Long memberId) {
        return myPageMapper.selectMyPageLikesWhole(memberId);
    }
