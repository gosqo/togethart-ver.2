...
public class MyPageApiController {
    ...
    */
    ...
    public ResponseEntity<List<MyPageArtworksResponse>> myPageArtworksGet(
            @PathVariable("memberId") Long memberId) {
        return ResponseEntity.ok().body(myPageService.getMyPageArtworks(memberId));
    }

    @GetMapping("api/member/{memberId}/artworksWhole")
    public ResponseEntity<List<MyPageArtworksResponse>> myPageArtworksWholeGet(
            @PathVariable("memberId") Long memberId) {
        return ResponseEntity.ok().body(myPageService.getMyPageArtworksWhole(memberId));
    }
    /*
    ...
    */
    @GetMapping("api/member/{memberId}/likesHome")
    public ResponseEntity<List<MyPageLikesResponse>> myPageLikesGet(
            @PathVariable("memberId") Long memberId) {
        return ResponseEntity.ok().body(myPageService.getMyPageLikes(memberId));
    }

    @GetMapping("api/member/{memberId}/likesWhole")
    public ResponseEntity<List<MyPageLikesResponse>> myPageLikesWholeGet(
            @PathVariable("memberId") Long memberId) {
        return ResponseEntity.ok().body(myPageService.getMyPageLikesWhole(memberId));
    }
